...
def get_memory_service():
    """Process-wide memory service for Vertex AI Memory Bank."""
    ...
    memory_bank_id = (
        ...
        or "6156855547464253440"
    )
    if memory_bank_id:
        from google.adk.memory import VertexAiMemoryBankService

        project = os.environ.get("GOOGLE_CLOUD_PROJECT") or "qwiklabs-gcp-03-9a71b17e4d3a"
        location = (
