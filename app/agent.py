...
from app.tools.external_api_tools import fetch_public_exercise_catalog
...
a2ui_instruction = schema_manager.generate_system_prompt(
    role_description=(
        "ActiveRoutine Coach & Productivity Companion, a helpful AI assistant. "
        "You remember the user's stated preferences, workout routines, daily schedules, "
